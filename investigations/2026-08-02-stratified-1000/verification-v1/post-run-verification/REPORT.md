...
**PARTIAL: no output defect recurred, but one or more affected routes were not exercised live.**
...
| Verdicts | {"FAILED_NO_DATA": 1, "FAILED_UNREACHABLE": 1, "SUCCESS": 22, "SUCCESS_PLAN_LEVEL": 5} |
| Unit rows | 1188 |
| Synthetic IDs | 0 |
...
| timeout_diagnostics | 1 / 7 | 1 / 7 | 0 | PARTIAL_RUNTIME_EXERCISED |
