...
def make_http_client(tier: FetchTier, proxy: str | None) -> _HttpxAdapter | _CurlCffiAdapter:
    ...
    this at DIRECT unlocks the bulk of currently-CF-walled properties
    without ever consulting the proxy pool. The default stays on httpx so
    the switch is a deliberate ops decision, not a silent regression risk.
    """
